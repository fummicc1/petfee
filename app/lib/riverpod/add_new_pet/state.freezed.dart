...
/// @nodoc
class _$AddNewPetStateTearOff {
  const _$AddNewPetStateTearOff();

  _AddNewPetState call(
      {String petName = "",
      int numberOfFeedPerDay = 2,
      bool showLoading = false,
      bool canCompleteNewPetSettings = false,
      XFile? petAvatar}) {
    return _AddNewPetState(
      petName: petName,
      numberOfFeedPerDay: numberOfFeedPerDay,
      showLoading: showLoading,
      canCompleteNewPetSettings: canCompleteNewPetSettings,
      petAvatar: petAvatar,
    );
  }
}
...
/// @nodoc
const $AddNewPetState = _$AddNewPetStateTearOff();
...
/// @nodoc
abstract class _$AddNewPetStateCopyWith<$Res>
    implements $AddNewPetStateCopyWith<$Res> {
  factory _$AddNewPetStateCopyWith(
          _AddNewPetState value, $Res Function(_AddNewPetState) then) =
      __$AddNewPetStateCopyWithImpl<$Res>;
  @override
  $Res call(
      {String petName,
      int numberOfFeedPerDay,
...
/// @nodoc
class __$AddNewPetStateCopyWithImpl<$Res>
    extends _$AddNewPetStateCopyWithImpl<$Res>
    implements _$AddNewPetStateCopyWith<$Res> {
  __$AddNewPetStateCopyWithImpl(
      _AddNewPetState _value, $Res Function(_AddNewPetState) _then)
      : super(_value, (v) => _then(v as _AddNewPetState));

  @override
  _AddNewPetState get _value => super._value as _AddNewPetState;
...
class _$_AddNewPetState implements _AddNewPetState {
  ...
  @JsonKey(ignore: true)
  @override
  _$AddNewPetStateCopyWith<_AddNewPetState> get copyWith =>
      __$AddNewPetStateCopyWithImpl<_AddNewPetState>(this, _$identity);
}
...
abstract class _AddNewPetState implements AddNewPetState {
  factory _AddNewPetState(
      ...
      bool showLoading,
      bool canCompleteNewPetSettings,
      XFile? petAvatar}) = _$_AddNewPetState;

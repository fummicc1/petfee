...
import 'package:petfee/riverpod/join_group/state.dart';
...
final joinGroupController =
  ...
  final _petRepository = ref.watch(petRepositoryProvider);
  final _pushNotificationClient = ref.watch(pushNotificationProvider);
  return JoinGroupController(
    state,
    _authRepository,
    _petRepository,
    _pushNotificationClient,
  );
});
